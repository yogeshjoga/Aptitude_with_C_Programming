# Aptitude_with_C_Programming
Hello guys this JOGA YOGESH, I will demonstrate Aptitude with C programming, READY GUYS LET'S


## Open the questions folder 
  open folder
  search the new questions
